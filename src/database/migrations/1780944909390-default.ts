...
export class Default1780944909390 implements MigrationInterface {
    name = 'Default1780944909390'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "campaign" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "display_name" character varying NOT NULL, "utm_campaign" character varying NOT NULL, "utm_id" character varying NOT NULL, "status" boolean NOT NULL DEFAULT true, "description" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "company_id" uuid, CONSTRAINT "UQ_c8e4316de02428bb13e0f080adf" UNIQUE ("utm_id"), CONSTRAINT "PK_0ce34d26e7f2eb316a3a592cdc4" PRIMARY KEY ("id"))`);
