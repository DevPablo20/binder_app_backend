import { Controller, Post, Body, HttpCode, HttpStatus, Res, Param } from '@nestjs/common'
...
export class AuthController {
    ...
    @ApiOperation({ summary: 'Logout', description: 'Remover autenticação do usuário logado' })
