...
export class MailService {
    ...
    async sendMail(
        ...
        const emailParams = new EmailParams()
            .setFrom(new Sender(this.config.get('MAIL_FROM_EMAIL') || '', this.config.get('MAIL_FROM_NAME')))
        ...
        try {
            ...
            console.error(err)
            throw new HttpException('Falha ao enviar e-mail', HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
